...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Test EnlightenAI with real data"
    )
    
    parser.add_argument(
        "repo_url", help="URL of the GitHub repository to analyze"
    )
    ...
    parser.add_argument(
        "--api-key", help="API key for the LLM provider (defaults to environment variable)"
    )
