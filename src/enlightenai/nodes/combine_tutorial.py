...
class CombineTutorialNode(Node):
    ...
    def _generate_index(self, repo_name: str, chapters: List[Dict[str, Any]]) -> str:
        ...
        for chapter in chapters:
            chapter_filename = chapter.get("filename", f"chapter_{chapter['number']:02d}.md")
            toc_items.append(f"{chapter['number']}. [{chapter['title']}](chapters/{chapter_filename})")
...
"""
    ...
    def _generate_html(self, context: Dict[str, Any], repo_name: str, chapters: List[Dict[str, Any]]) -> None:
...
"""
        ...
        # Add chapters
        for chapter in chapters:
            html_content += f'    <div id="chapter-{chapter["number"]}" class="chapter">\n'
    ...
    def _generate_pdf_ready(self, context: Dict[str, Any], repo_name: str, chapters: List[Dict[str, Any]]) -> None:
...
"""
    ...
    def _generate_github_pages(self, context: Dict[str, Any], repo_name: str, chapters: List[Dict[str, Any]]) -> None:
...
"""
    ...
    def _generate_html_viewer(self, context: Dict[str, Any], repo_name: str, chapters: List[Dict[str, Any]]) -> None:
        ...
        html_path = create_html_viewer(output_dir, f"{repo_name} - Code Walkthrough", chapters, diagrams)
